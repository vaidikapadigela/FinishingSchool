...
{
    public static int calculateTotalPoints(int[] power, int n, int k, int lower, int upper)
    {
        int points = 0, windowSum = 0;
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(calculateTotalPoints(power, n, k, lower, upper));
    }
}